...
Impostazioni (veicoli, lingua, chiave AI, sincronizzazione, backup) stanno nel
menù in alto a destra della Panoramica.
...
La lingua dell'interfaccia sta in una chiave a parte, `pit_lang`: non fa parte
dei dati, dei backup né della sincronizzazione.
...
## Licenza
MIT, vedi [LICENSE](LICENSE). Creata da [Massimo D'Ascola](https://github.com/massimodascola).
